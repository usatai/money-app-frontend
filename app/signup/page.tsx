...
export default function Home() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 p-4">
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-md p-6 sm:p-8 rounded-lg shadow-2xl">
            <h1 className="text-2xl sm:text-3xl font-bold text-center text-gray-800 mb-8 sm:mb-8">新規ユーザー登録</h1>
